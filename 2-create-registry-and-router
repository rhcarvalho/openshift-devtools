...
info "Creating router ..." "skipped: missing service account setup"
...
# FIXME need a service account to create a router
#oadm router --create --credentials=$OPENSHIFT_ROUTER_CONFIG --service-account=... -n default
